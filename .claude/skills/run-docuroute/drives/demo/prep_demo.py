...
scratch copy only: check that the demo accounts the drives use still sign
in with the demo password, and that the documents the paths use are fresh.
"""
from django.conf import settings
assert 'scratch' in settings.SETTINGS_MODULE, 'run with --settings=scratch_settings'
from django.contrib.auth import authenticate
from api.models import Manual, Proposal
